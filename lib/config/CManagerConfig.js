...
function CManagerConfig(opts, proxy = null) {
    ...
    this.market = new CMarketConfig(opts.market || {}, this.getHttpProxy());
...
CManagerConfig.prototype.getHttpProxy = function(opts = {}) {
    if(!this.proxy) {
        return null;
    }

    return Tunnel.httpsOverHttp({
        proxy: this._parseProxyUrl(this.proxy, opts)
    });
};
